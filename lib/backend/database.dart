...
class Database {
  ...
  addconversation(String chatroomID,chatMap) {
    Firestore.instance.collection("Chatroom").document(chatroomID).collection("chats").add(chatMap)
    .catchError((e){print(e.toString());});    
  }
  getconversation(String chatroomID) async{
    return Firestore.instance.collection("Chatroom").document(chatroomID).collection("chats").orderBy("time",descending: true).snapshots();    
  }
